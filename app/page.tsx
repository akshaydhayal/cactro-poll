...
//       await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/poll`, {
//         question: formData.question,
//         option: formData.options.filter((opt) => opt.trim()),
//       });
...
//                 <div>
//                   <label className="block text-sm font-medium text-gray-200 mb-1">Options</label>
//                   {formData.options.map((option, index) => (
...
//                         <Button type="button" variant="ghost" size="icon" onClick={() => handleRemoveOption(index)} className="text-gray-400 hover:text-white">
//                           <X className="w-4 h-4" />
//                         </Button>
//                       )}
//                     </div>
//                   ))}
//                   <Button type="button" variant="outline" onClick={handleAddOption} className="mt-2 w-full border-gray-600 text-gray-200 hover:text-white">
//                     Add Option
//                   </Button>
//                 </div>
